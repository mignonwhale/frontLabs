...
function registTodo(event) {
    let todo = { checked: false, content: content.value, seq: getSeq() }
    ...
    <div class="todo-wrapper">
        ...
        <div class="todo-box">
            ...
            <ul class="todo-list" id="todo-list">
                <li v-for="todo in todos" :key="todo.seq" class="todo-item" id="todo-item">
                    <input :value="todo.seq" type="hidden" id="seq">
                    <div class="checkbox" id="checked">{{ todo.checked ? "✔" : "" }}</div>
                    <div id="content">
                        <input :value="todo.content" id="content-update" class="todo">
                    </div>
                    <button class="delBtn" id="deleted">x</button>
                </li>
            </ul>
        </div>
    </div>
